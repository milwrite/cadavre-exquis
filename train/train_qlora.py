...
trains on a 24 GB laptop RTX 5090. The deployed game runs gemma-4-31b-it; the
recipe transfers upward — set MODEL=google/gemma-4-12B-it to move up once proven.
